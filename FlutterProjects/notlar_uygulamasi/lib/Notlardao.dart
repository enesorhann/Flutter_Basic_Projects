...
class Notlardao{
  ...
  Future<void> kayitEkle(String ders_adi,int not1,int not2) async{
    var db = await Veritabaniyardimcisi.veriTabaniErisim();
  ...
  Future<void> kayitGuncelle(int not_id,String ders_adi,int not1,int not2) async{
    var db = await Veritabaniyardimcisi.veriTabaniErisim();
  ...
  Future<void> kayitSil(int not_id) async{
    var db = await Veritabaniyardimcisi.veriTabaniErisim();
